      ...
      <nav class="shadow-lg mx-auto flex flex-wrap gap-4 px-8 lg:justify-evenly justify-between items-center py-6">
        <div>
          <nuxt-link v-if="theme === 'theme-light'" to="/">
            <h1 class="text-2xl text-orange-400">
              Marketingagency.
            </h1>
          </nuxt-link>
          <nuxt-link v-else to="/">
        ...
        <ul
          ...
          <li>
            <nuxt-link to="/service" class="text-black hover:text-orange-300 text-xl">Services</nuxt-link>
          </li>
          <li>
            <nuxt-link to="/portfolio" class="text-black hover:text-orange-300 text-xl">Portfolio</nuxt-link>
          </li>
          <li>
            <nuxt-link to="/contact" class="text-black hover:text-orange-300 text-xl">Contact</nuxt-link>
          </li>
      ...
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div class="flex flex-col lg:flex-row gap-2">
            <span>Copyright {{ new Date().getFullYear() }} marketingagency </span>
  ...
  export default {
    ...
    mounted() {
      ...
      (function () {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/6429dd3e31ebfa0fe7f61634/1gt1ogfmh';
        s1.charset = 'UTF-8';
